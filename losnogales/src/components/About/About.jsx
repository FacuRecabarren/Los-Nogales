...
const About = () => {
  return (
    <div className='flex justify-center items-center gap-16 px-32 py-20'>
        ...
        NOSOTROS
        <span className="absolute bottom-2 left-0 w-full h-[1px] bg-[]"></span>
        <span className="absolute bottom-0 left-0 w-full h-[6px] bg-[#252525]"></span> 
        </h2>
            <h3 className='font-lora text-2xl text-[#252525]'>Welcome to Dina, a modern restaurant with a focus on premium food tastes</h3>
