  ...
  return (
    <div className="flex items-center">
      ...
      <label className="relative inline-flex items-center cursor-pointer">
        ...
        <div onClick={changeLanguage} className="w-11 h-6 bg-[#594225] peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-palette-500 after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-secondary  after:border-palette-500 after:border-2 after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#594225]"></div>
      </label>
